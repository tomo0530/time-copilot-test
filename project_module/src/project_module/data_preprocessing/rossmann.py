...
class RossmannPreprocessor(BasePreprocessor):
    """Preprocessor for the Rossmann Store Sales dataset."""
    ...
    def prepare(self) -> PreparedDataset:
        ...
        ensure_columns(df=df, columns=[date_column, target_column, "Store"])
        ...
        if self._preprocessing.exclude_zero_sales:
        ...
        metadata = df[["unique_id", "Store"]].drop_duplicates()
